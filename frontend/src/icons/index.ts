...
import { ReactComponent as FirstPageIcon } from "./first-page-icon.svg?react";
import { ReactComponent as PreviousPageIcon } from "./previous-page-icon.svg?react";
import { ReactComponent as NextPageIcon } from "./next-page-icon.svg?react";
