    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="container mx-auto px-6 py-10">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
          <div>
            <h1 className="text-4xl font-bold text-gray-800 mb-2">Summer Sale</h1>
            <p className="text-gray-600">Get up to 50% off on selected items</p>
          </div>
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <span className="text-sm text-gray-500 line-through ml-2">${(p.price * 1.25).toFixed(2)}</span>
                  </div>
