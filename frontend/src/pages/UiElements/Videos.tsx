...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | EcomPro - React.js Admin Dashboard Template"
        description="This is React.js Videos page for EcomPro - React.js Tailwind CSS Admin Dashboard Template"
      />
