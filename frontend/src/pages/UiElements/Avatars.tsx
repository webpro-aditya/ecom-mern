...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | EcomPro - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for EcomPro - React.js Tailwind CSS Admin Dashboard Template"
      />
